...
event2 = Event.create!(
  ...
  title: 'Movie Night',
  description: "Snap. Crackle. Pop some (pop)corn. We also have movies.
...
event3 = Event.create!(
  ...
  category: 'Music',
  title: 'Rave the Cave',
  description: "Getting tired of man-made concert venues? well, now’s your chance to rave where we’re supposed to rave: in a cave, obviously.
...
event4 = Event.create!(
  ...
  description: "Build a church while building friendships! Prior experience with construction is required. If you can, bring your own tools.
  
  Nam elementum mollis nibh, et interdum eros aliquet vitae. Nullam suscipit magna quam, eu consectetur eros fermentum at. Nulla diam magna, sagittis vel lacinia ac, suscipit et odio.",
...
event5 = Event.create!(
  ...
  category: 'Entertainment',
  title: 'Potion Making',
  description: "Create some magic in this potion making class. This event is meant for beginners, although expert wizards and witches are welcome.
  
  Mauris ultrices, neque vel maximus efficitur, felis leo consectetur ligula, maximus interdum arcu nibh eget massa. In non mi porta, iaculis magna ut, aliquam mi. Nam elementum mollis nibh, et interdum eros aliquet vitae. Nullam suscipit magna quam, eu consectetur eros fermentum at.",
...
event7 = Event.create!(
  ...
  description: "So you’ve been keeping up with the news and now you have an opinion. Except your friends are getting tired of listening to your politics. Margs and Args is a safe place for expressing your opinions to strangers while having a drink!",
...
event8 = Event.create!(
  ...
  category: 'Charity and Causes',
  title: 'Bars for Mars',
  description: "Look, Earth is great and all, but it’s time for humans to become the next interplanetary species. Bars for Mars is a NASA fundraiser where local artists freestyle rap to spacey beats.",
